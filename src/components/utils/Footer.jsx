    ...
    <>
      <footer className="bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-16 md:grid-cols-2 lg:grid-cols-3">
            <div className="">
              ...
              <p>
                ...
                nemo odio nulla porro dolores laudantium cupiditate assumenda
                quia dicta esse sunt modi cum illo, voluptates eveniet, rem est.
                Voluptatibus, itaque?
              </p>
            </div>
